...
with st.sidebar:
    ...
    selling_price = st.slider("Wholesale Selling Price per pill ($)", min_value=0.05, max_value=0.50, value=0.33, step=0.01)
...
_, true_optimal_hub, _, _, _, _, _ = run_milp(
    ...
    roo_compliant, afcfta_phase_down, selling_price, base_prod_cost, target_volume, friction_multiplier,forex_liquidity,
    forced_hub=None
)
